...
$user_name = 'Pablo'; // укажите здесь ваше имя
?>
<!DOCTYPE html>
<html lang="ru">
<head>
    <meta charset="UTF-8">
    <title>Главная</title>
    <link href="http://localhost/1496267-yeticave-12/css/normalize.min.css" rel="stylesheet">
    <link href="http://localhost/1496267-yeticave-12/css/style.css" rel="stylesheet">
</head>
<body>
...
<header class="main-header">
    <div class="main-header__container container">
        ...
        <a class="main-header__logo">
            <img src="http://localhost/1496267-yeticave-12/img/logo.svg" width="160" height="39" alt="Логотип компании YetiCave">
        </a>
        ...
        <ul class="lots__list">
            ...
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?= $val['pic_url']; ?>" width="350" height="260" alt="<?= $val['category']; ?>">
                </div>
                <div class="lot__info">
